      ...
      >
        ...
        <div className="flex gap-4 justify-between items-center py-1 mt-2 w-full text-xs rounded">
          ...
          <div className="flex gap-2 items-center self-stretch my-auto">
            <button 
              className="bg-white hover:bg-gray-50 text-gray-800 border border-gray-300 hover:border-gray-400 px-4 py-2 rounded-full shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center gap-2 font-semibold text-xs"
