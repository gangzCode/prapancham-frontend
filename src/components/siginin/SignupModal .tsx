...
const SignupModal: React.FC<SignupModalProps> = ({ isOpen, onClose }) => {
    ...
    const translations: Record<LanguageKey, { [key: string]: string }> = {
        en: {
            ...
            accountCreated: "Your account data has been stored. Please verify the OTP to complete the sign-up process.",
        ...
        ta: {
            ...
            accountCreated: "உங்கள் கணக்குத் தரவு சேமிக்கப்பட்டுள்ளது. பதிவுசெய்தல் செயல்முறையை முடிக்க OTP ஐச் சரிபார்க்கவும்.",
        ...
        si: {
            ...
            accountCreated: "ඔබගේ ගිණුම් දත්ත ගබඩා කර ඇත. ලියාපදිංචි වීමේ ක්‍රියාවලිය සම්පූර්ණ කිරීම සඳහා කරුණාකර OTP සත්‍යාපනය කරන්න.",
