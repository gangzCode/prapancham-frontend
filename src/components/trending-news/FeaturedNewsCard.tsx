...
export const FeaturedNewsCard: React.FC<FeaturedNewsCardProps> = ({
  ...
  return (
    <article className="self-stretch p-3 sm:p-2 bg-white shadow-[0px_0px_12px_rgba(0,0,0,0.06)] w-full min-w-full md:min-w-full lg:min-w-full xl:min-w-60 md:max-w-full lg:max-w-full xl:max-w-[578px]">
      <div className="relative w-full text-white">
        <div
          className="relative aspect-[4/3] sm:aspect-[16/10] bg-cover bg-center h-[380px]"
